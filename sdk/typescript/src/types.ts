...
/** Discriminated union of every SSE stream event emitted by the backend. */
export type StreamEvent =
  | { type: "chunk"; token: string; reasoning?: string; agent: string; chunk_index: number; total_chars: number; phase?: string; trace_id?: string; mode: string | null; risk_score: string | null; degrade_policy: string | null }
  | { type: "done"; agent: string; done: boolean; chunks: number; total_chars: number; duration_ms: number; phase?: string; trace_id?: string; mode: string | null; risk_score: string | null; degrade_policy: string | null; selected_model?: string; response?: string }
  | { type: "error"; error: string; message?: string }
  | { type: "phase_end"; phase: string; description: string; progress_current?: number; progress_total?: number }
  | { type: "phase_start"; phase: string; description: string; progress_current?: number; progress_total?: number }
  | { type: "progress"; message: string }
  | { type: "result"; response: string; agent: string; done: boolean }
  | { type: "status"; message: string; round_current?: number; round_total?: number }
  | { type: "telemetry"; agent: string; phase: string; trace_id: string; mode: string | null; risk_score: string | null; degrade_policy: string | null; token_economy: Record<string, unknown> }
  | { type: "tool_approval"; tool_name: string; tool_args: Record<string, unknown>; mode: string; risk_score: number; message: string };
