  ...
  <el-row v-else :gutter="16">
    ...
    <el-col :span="24" style="margin-top:16px;">
      <el-card>
        ...
        <div v-else style="text-align:center;padding:20px;color:#999;">{{ t('aiUsageView.noTrendData') }}</div>
      </el-card>
    </el-col>
    <el-col :span="12" style="margin-top:16px;">
      <el-card>
        ...
        <div v-else style="text-align:center;padding:20px;color:#999;">{{ t('aiUsageView.noPhaseData') }}</div>
      </el-card>
    </el-col>
    <el-col :span="12" style="margin-top:16px;">
      <el-card>
        ...
        <div v-else style="text-align:center;padding:20px;color:#999;">{{ t('aiUsageView.noAgentData') }}</div>
      </el-card>
    </el-col>
  </el-row>
</template>
