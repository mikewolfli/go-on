<template>
  <el-card>
    ...
    <el-space direction="vertical" alignment="start" style="width:100%">
      ...
      <el-space wrap>
        <el-button @click="call('breaker.status')">{{ t("views.BackendOpsView.breakerStatus") }}</el-button>
        <el-button type="warning" @click="callDangerous('breaker.reset')">{{ t("views.BackendOpsView.breakerReset") }}</el-button>
        <el-button type="warning" plain @click="call('breaker.recovery', { dry_run: true })">{{ t("views.BackendOpsView.breakerRecovery") }}</el-button>
        <el-button @click="call('config.reload')">{{ t("views.BackendOpsView.configReload") }}</el-button>
        ...
        <el-button type="danger" @click="callDangerous('shutdown')">{{ t("views.BackendOpsView.shutdownBtn") }}</el-button>
      </el-space>

      <el-space wrap>
        <el-button @click="callDangerous('cache.clear')">{{ t("views.BackendOpsView.cacheClearBtn") }}</el-button>
        <el-button @click="callDangerous('vector.clear')">{{ t("views.BackendOpsView.vectorClearBtn") }}</el-button>
      </el-space>

      <el-space wrap>
        <el-button type="success" @click="callQualityBaseline">{{ t("backendOps.qualityBaseline") }}</el-button>
        <el-button type="success" plain @click="call('harness.status', { seed: 20260415 })">{{ t("views.BackendOpsView.harnessStatus") }}</el-button>
        <el-button type="success" plain @click="call('learning.guardrail', { limit: 50 })">{{ t("views.BackendOpsView.learningGuardrail") }}</el-button>
        ...
        <el-button @click="call('metrics.get')">{{ t("views.BackendOpsView.metricsGet") }}</el-button>
        <el-button @click="call('metrics.prometheus')">{{ t("views.BackendOpsView.metricsPrometheus") }}</el-button>
      </el-space>

      <el-space wrap>
        <el-button @click="call('trace.get')">{{ t("views.BackendOpsView.traceGet") }}</el-button>
        <el-button @click="call('trace.metrics')">{{ t("views.BackendOpsView.traceMetrics") }}</el-button>
        <el-button type="danger" plain @click="call('security.baseline')">{{ t("views.BackendOpsView.securityBaseline") }}</el-button>
        ...
        <el-button type="warning" plain @click="call('observability.alerts', { limit: 20 })">{{ t("views.BackendOpsView.observabilityAlerts") }}</el-button>
        <el-button @click="call('debug_panel.get')">{{ t("views.BackendOpsView.debugPanel") }}</el-button>
      </el-space>
