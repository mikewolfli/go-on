...
interface CoreCommandRegistryDeps {
    ...
    buildPlaceholderEnvValues: (_missingEnvVarNames: string[]) => Record<string, string>;
    start: (_configPath: string, _executablePath: string, _cwd: string, _protocolMode: string) => Promise<void>;
    stop: () => void;
    isRunning: () => boolean;
