...
export interface ViewCommandRegistryDeps {
    revealGoOnView: (_target: 'chat' | 'settings' | 'workflow' | 'process-flow') => Promise<boolean>;
...
export function registerViewCommands(deps: ViewCommandRegistryDeps): vscode.Disposable[] {
