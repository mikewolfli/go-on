...
//!
//! Input conversion, response builders, payload store, tool helpers,
//! validation, and the streaming handlers. Split out of the former
//! monolithic `openai_compat.rs` (M0.4); the Chat Completions path lives in
//! the sibling [`super::chat_completions`] module.
