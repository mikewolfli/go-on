#[cfg(test)]
mod tests {
    use crate::intelligence::code_quality::{CodeQualityIssue, CodeQualityReport};
        ...
        async fn generate(
            ...
            if let Some(ref cs) = report.consciousness_profile {
                ...
                if cs.overall_awareness < 0.3 {
                    recs.push(
                        "Improve data collection to raise consciousness awareness.".to_string(),
                    );
                }
            }
