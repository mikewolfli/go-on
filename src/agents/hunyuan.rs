...
impl HunyuanAgent {
    ...
    async fn chat_once(
        ...
        if !response.status().is_success() {
            ...
            anyhow::bail!(
                "{}",
                chat_request_failed_msg("hunyuan", &status.to_string(), &body)
            );
        }
...
impl Agent for HunyuanAgent {
    async fn chat(
        ...
        Err(last_error
            .unwrap_or_else(|| anyhow::anyhow!("{}", request_failed_msg("hunyuan")))
            .into())
    }
    ...
    fn available_models(&self) -> Vec<ModelInfo> {
        vec![
            ModelInfo {
                id: "hunyuan-turbo-latest".to_string(),
                name: "Hunyuan Turbo Latest".to_string(),
                description: "Tencent Hunyuan Turbo Latest (fast, latest generation)".to_string(),
                is_default: self.model == "hunyuan-turbo-latest",
                capabilities: vec!["chat".to_string(), "function_calling".to_string()],
                context_window: Some(131072),
            },
            ModelInfo {
                id: "hunyuan-turbo".to_string(),
                name: "Hunyuan Turbo".to_string(),
                description: "Tencent Hunyuan Turbo (balanced, high performance)".to_string(),
                is_default: self.model == "hunyuan-turbo",
                capabilities: vec!["chat".to_string(), "function_calling".to_string()],
                context_window: Some(131072),
            },
            ModelInfo {
                id: "hunyuan-pro".to_string(),
                name: "Hunyuan Pro".to_string(),
                description: "Tencent Hunyuan Pro (most capable)".to_string(),
                is_default: self.model == "hunyuan-pro",
                capabilities: vec!["chat".to_string(), "function_calling".to_string()],
