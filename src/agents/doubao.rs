//! ByteDance Doubao agent implementation
//!
//! This module provides an implementation for the ByteDance Doubao API.
...
impl DoubaoAgent {
    ...
    async fn chat_once(
        ...
        if !response.status().is_success() {
            ...
            anyhow::bail!("doubao chat request failed with {status}: {body}");
        }
